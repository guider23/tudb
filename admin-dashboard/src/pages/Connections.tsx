...
const providerConfig: Record<string, { icon: string; label: string; gradient: string; isImage?: boolean }> = {
  supabase: { icon: 'https://img.icons8.com/color/512/supabase.png', label: 'Supabase', gradient: 'from-emerald-50 to-emerald-100', isImage: true },
  neon: { icon: 'https://neon.tech/favicon/favicon.png', label: 'Neon', gradient: 'from-purple-50 to-purple-100', isImage: true },
  railway: { icon: 'https://railway.app/brand/logo-light.png', label: 'Railway', gradient: 'from-pink-50 to-pink-100', isImage: true },
  rds: { icon: 'https://a0.awsstatic.com/libra-css/images/logos/aws_logo_smile_179x109.png', label: 'AWS RDS', gradient: 'from-orange-50 to-orange-100', isImage: true },
  planetscale: { icon: 'https://avatars.githubusercontent.com/u/35612527', label: 'PlanetScale', gradient: 'from-slate-50 to-slate-100', isImage: true },
  azuremysql: { icon: 'https://swimburger.net/media/ppnn3pcl/azure.png', label: 'Azure MySQL', gradient: 'from-blue-50 to-blue-100', isImage: true },
  // PostgreSQL cloud providers
  herokupostgres: { icon: 'https://cdn.worldvectorlogo.com/logos/heroku-4.svg', label: 'Heroku Postgres', gradient: 'from-purple-50 to-purple-100', isImage: true },
  googlecloudsql: { icon: 'https://marketplace.crowdstrike.com/content/dam/crowdstrike/marketplace/en-us/images/Googlecloud_icon_square.png', label: 'Google Cloud SQL (PostgreSQL)', gradient: 'from-red-50 to-yellow-50', isImage: true },
  azurepostgres: { icon: 'https://swimburger.net/media/ppnn3pcl/azure.png', label: 'Azure PostgreSQL', gradient: 'from-blue-50 to-cyan-50', isImage: true },
  digitaloceanpostgres: { icon: 'https://www.vectorlogo.zone/logos/digitalocean/digitalocean-icon.svg', label: 'DigitalOcean PostgreSQL', gradient: 'from-blue-50 to-blue-100', isImage: true },
  aivenpostgres: { icon: 'https://assets.topadvisor.com/media/_solution_logo_09222023_26755928.png', label: 'Aiven PostgreSQL', gradient: 'from-indigo-50 to-indigo-100', isImage: true },
  render: { icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSSlZQ5lkKr_NTo29xqy0X5VQSQknoPuhuu3A&s', label: 'Render PostgreSQL', gradient: 'from-purple-50 to-pink-100', isImage: true },
  cockroachdb: { icon: 'https://www.vectorlogo.zone/logos/cockroachlabs/cockroachlabs-icon.svg', label: 'CockroachDB', gradient: 'from-blue-50 to-indigo-100', isImage: true },
  timescalecloud: { icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR1QlKlW-KT-OZe6dffDTgSEf3abClfbRdtYA&s', label: 'Timescale Cloud', gradient: 'from-orange-50 to-yellow-100', isImage: true },
  // MySQL cloud providers
  googlecloudsqlmysql: { icon: 'https://marketplace.crowdstrike.com/content/dam/crowdstrike/marketplace/en-us/images/Googlecloud_icon_square.png', label: 'Google Cloud SQL (MySQL)', gradient: 'from-red-50 to-yellow-50', isImage: true },
  digitaloceanmysql: { icon: 'https://www.vectorlogo.zone/logos/digitalocean/digitalocean-icon.svg', label: 'DigitalOcean MySQL', gradient: 'from-blue-50 to-blue-100', isImage: true },
  aivenmysql: { icon: 'https://assets.topadvisor.com/media/_solution_logo_09222023_26755928.png', label: 'Aiven MySQL', gradient: 'from-indigo-50 to-indigo-100', isImage: true },
  auroramysql: { icon: 'https://a0.awsstatic.com/libra-css/images/logos/aws_logo_smile_179x109.png', label: 'AWS Aurora MySQL', gradient: 'from-orange-50 to-orange-100', isImage: true },
  // Legacy support
            ...
            <div className="xl:col-span-1">
              <div className="sticky top-28 flex flex-col gap-5">
                ...
                <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-5">
                        ...
                        <div className="absolute z-50 w-full mt-2 bg-white/95 backdrop-blur-2xl border border-[#E5E5E7] rounded-xl shadow-[0_8px_32px_rgba(0,0,0,0.12)] overflow-hidden">
                          <div className="py-2 max-h-[400px] overflow-y-auto">
                            {[
                              ...
                              { value: 'supabase', label: 'Supabase', logo: 'https://img.icons8.com/color/512/supabase.png' },
                              { value: 'neon', label: 'Neon', logo: 'https://neon.tech/favicon/favicon.png' },
                              { value: 'railway', label: 'Railway', logo: 'https://railway.app/brand/logo-light.png' },
                              { value: 'rds', label: 'AWS RDS', logo: 'https://a0.awsstatic.com/libra-css/images/logos/aws_logo_smile_179x109.png' },
                              { value: 'planetscale', label: 'PlanetScale', logo: 'https://avatars.githubusercontent.com/u/35612527' },
                              { value: 'azuremysql', label: 'Azure MySQL', logo: 'https://swimburger.net/media/ppnn3pcl/azure.png' },
                              { value: 'herokupostgres', label: 'Heroku Postgres', logo: 'https://cdn.worldvectorlogo.com/logos/heroku-4.svg' },
                              { value: 'googlecloudsql', label: 'Google Cloud SQL (PostgreSQL)', logo: 'https://marketplace.crowdstrike.com/content/dam/crowdstrike/marketplace/en-us/images/Googlecloud_icon_square.png' },
                              { value: 'azurepostgres', label: 'Azure PostgreSQL', logo: 'https://swimburger.net/media/ppnn3pcl/azure.png' },
                              { value: 'digitaloceanpostgres', label: 'DigitalOcean PostgreSQL', logo: 'https://www.vectorlogo.zone/logos/digitalocean/digitalocean-icon.svg' },
                              { value: 'aivenpostgres', label: 'Aiven PostgreSQL', logo: 'https://assets.topadvisor.com/media/_solution_logo_09222023_26755928.png' },
                              { value: 'render', label: 'Render PostgreSQL', logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSSlZQ5lkKr_NTo29xqy0X5VQSQknoPuhuu3A&s' },
                              { value: 'cockroachdb', label: 'CockroachDB', logo: 'https://www.vectorlogo.zone/logos/cockroachlabs/cockroachlabs-icon.svg' },
                              { value: 'timescalecloud', label: 'Timescale Cloud', logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR1QlKlW-KT-OZe6dffDTgSEf3abClfbRdtYA&s' },
                              { value: 'googlecloudsqlmysql', label: 'Google Cloud SQL (MySQL)', logo: 'https://marketplace.crowdstrike.com/content/dam/crowdstrike/marketplace/en-us/images/Googlecloud_icon_square.png' },
                              { value: 'digitaloceanmysql', label: 'DigitalOcean MySQL', logo: 'https://www.vectorlogo.zone/logos/digitalocean/digitalocean-icon.svg' },
                              { value: 'aivenmysql', label: 'Aiven MySQL', logo: 'https://assets.topadvisor.com/media/_solution_logo_09222023_26755928.png' },
                              { value: 'auroramysql', label: 'AWS Aurora MySQL', logo: 'https://a0.awsstatic.com/libra-css/images/logos/aws_logo_smile_179x109.png' },
                            ].map((option, index) => (
                              <button
                  ...
                  {/* Connection URI */}
                  <div className="flex flex-col gap-2">
                    <label className="text-[12px] font-semibold text-[#86868B] uppercase tracking-wide pl-1">
                      Connection URI
                    </label>
